...
class YiiDebugToolbarPanelSql extends YiiDebugToolbarPanel
{
    ...
    public function getServerInfo($connectionId)
    {
        ...
        if (null !== ($connection = Yii::app()->getComponent(
                $connectionId
            )) && false !== ($connection instanceof CDbConnection) && 'sqlite' !== $connection->driverName && '' !== ($serverInfo = $connection->getServerInfo(
            ))
        ) {
            $info = array(
