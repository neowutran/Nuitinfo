...
class CWebUser extends CApplicationComponent implements IWebUser
{
    ...
    public function getReturnUrl($defaultUrl = null)
    {
        ...
        if ($defaultUrl === null) {
            $defaultReturnUrl = Yii::app()->getUrlManager()->showScriptName ? Yii::app()->getRequest()->getScriptUrl(
    ...
    protected function restoreFromCookie()
    {
        ...
        if ($cookie && !empty($cookie->value) && is_string($cookie->value) && ($data = $app->getSecurityManager(
