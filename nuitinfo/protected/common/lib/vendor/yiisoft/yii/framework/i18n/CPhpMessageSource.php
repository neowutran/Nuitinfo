        ...
        if (!isset($this->_files[$category][$language])) {
            if (($pos = strpos($category, '.')) !== false) {
                ...
                if (isset($this->extensionPaths[$extensionClass])) {
                    $this->_files[$category][$language] = Yii::getPathOfAlias(
                            $this->extensionPaths[$extensionClass]
                    ...
                    $this->_files[$category][$language] = dirname(
                            $class->getFileName()
                        ) . DIRECTORY_SEPARATOR . 'messages' . DIRECTORY_SEPARATOR . $language . DIRECTORY_SEPARATOR . $extensionCategory . '.php';
                }
            } else {
