...
class YiiBase
{
    ...
    public static function import($alias, $forceInclude = false)
    {
        ...
        if (($path = self::getPathOfAlias($alias)) !== false) {
            ...
            } else // a directory
            {
                ...
                if (self::$enableIncludePath && set_include_path(
                        '.' . PATH_SEPARATOR . implode(PATH_SEPARATOR, self::$_includePaths)
                    ) === false
                ) {
    ...
    public static function powered()
    {
        ...
        return Yii::t(
            'yii',
            'Powered by {yii}.',
            array('{yii}' => '<a href="http://www.yiiframework.com/" rel="external">Yii Framework</a>')
        );
    }
