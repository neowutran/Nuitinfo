                ...
                if ($this->_states[$this->_state][$i] != -1) {
                    ...
                    if (isset($this->_parts[$this->_state][$i])) {
                        ...
                        for ($j = 1; $j <= $count; $j++) {
                            ...
                            if (isset($this->_parts[$this->_state][$i][$j])) {
                                if ($m[$j + $n][1] > $partpos) {
                                    array_unshift(
                                        $parts,
                                        array($inner, substr($this->_str, $partpos, $m[$j + $n][1] - $partpos))
                                    );
                                }
                        ...
                        if ($partpos < $m[$n][1] + strlen($m[$n][0])) {
                            array_unshift(
                                $parts,
                                array($inner, substr($this->_str, $partpos, $m[$n][1] - $partpos + strlen($m[$n][0])))
                            );
                        }
                ...
                if ($this->_states[$this->_state][$i] != -1) {
                    ...
                    if ($this->_subst[$l][$i]) {
                        for ($k = 0; $k <= $this->_counts[$l][$i]; $k++) {
                            ...
                            $this->_endpattern = str_replace(
                                '%b' . $k . '%',
                                $this->_matchingBrackets($quoted),
                                $this->_endpattern
                            );
                        }
                    }
