...
class CDateFormatterTest extends CTestCase
{
    ...
    public function testStringIntegerDate()
    {
        ...
        $this->assertEquals(
            '2012 09 03 07:54:09',
            Yii::app()->dateFormatter->format("yyyy MM dd hh:mm:ss", 1346702049)
        );
        $this->assertEquals(
            '2012 09 03 07:54:09',
            Yii::app()->dateFormatter->format("yyyy MM dd hh:mm:ss", '1346702049')
    ...
    public function testStrToTimeDate()
    {
        ...
        $this->assertEquals(
            '2012 09 03 09:54:09',
            Yii::app()->dateFormatter->format("yyyy MM dd hh:mm:ss", '2012-09-03 09:54:09 UTC')
        );
        $this->assertEquals(
            '1927 04 30 05:05:51',
            Yii::app()->dateFormatter->format("yyyy MM dd hh:mm:ss", '1927-04-30 05:05:51 UTC')
        );
    }
    ...
    public function testFormatWeekInMonth($date, $expected)
    {
        ...
        $this->assertEquals(
            $expected,
            Yii::app()->dateFormatter->format('W', mktime(12, 0, 0, (int)$month, (int)$day, (int)$year))
        );
    }
}
