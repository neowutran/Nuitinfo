...
class MessageCommandTest extends CTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->configFileName = Yii::getPathOfAlias(
                'application.runtime'
            ) . DIRECTORY_SEPARATOR . 'message_command_test_config.php';
    }
    ...
    protected function createMessageCommand()
    {
        ...
        $command->expects($this->any())->method('usageError')->will(
            $this->throwException(new CException('usageError'))
        );
        return $command;
    }
    ...
    public function testCreateTranslation()
    {
        ...
        $this->assertTrue(
            file_exists($this->messagePath . DIRECTORY_SEPARATOR . $language),
