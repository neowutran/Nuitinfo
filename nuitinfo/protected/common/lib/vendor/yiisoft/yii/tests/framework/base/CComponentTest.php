...
class CComponentTest extends CTestCase
{
    ...
    public function testCallMethodFromBehavior()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('CException', $e);
            $this->assertSame(
                'NewComponent and its behaviors do not have a method or closure named "otherMethod".',
                $e->getMessage()
            );
        }
    }
    ...
    public function testInvalidHandler1()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('CException', $e);
            $this->assertSame(
                'Event "NewComponent.onmyevent" is attached with an invalid handler "array".',
                $e->getMessage()
            );
        }
    }
    ...
    public function testInvalidHandler2()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('CException', $e);
            $this->assertSame(
                'Event "NewComponent.onmyevent" is attached with an invalid handler "nullHandler".',
                $e->getMessage()
            );
        }
    }
    ...
    public function testDetachingBehaviors()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('CException', $e);
            $this->assertSame(
                'NewComponent and its behaviors do not have a method or closure named "test".',
                $e->getMessage()
            );
        }
    }
    ...
    public function testEvaluateExpression()
    {
        ...
        $this->assertSame(
            'Hello world',
            $this->component->evaluateExpression(array($this->component, 'exprEvaluator'), array('who' => 'world'))
        );
    }
}
