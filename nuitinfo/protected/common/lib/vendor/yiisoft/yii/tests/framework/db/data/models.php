...
class User extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'postsCondition'          => array(
                self::HAS_MANY,
                'Post',
                'author_id',
                'condition' => 'postsCondition.id IN (2,3)'
            ),
            ...
            'mentorshipsCustomSelect' => array(
                self::HAS_MANY,
                'Mentorship',
                'teacher_id',
                'select' => array('teacher_id', 'student_id')
            ),
            'studentsCustomSelect'    => array(
                self::HAS_MANY,
                'User',
                array('student_id' => 'id'),
                'through' => 'mentorshipsCustomSelect',
...
class Group extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'rolesWhichEmptyByCondition' => array(
                self::HAS_MANY,
                'Role',
                'group_id',
                'condition' => '2=:compareValue',
                'params'    => array(':compareValue' => 1)
            ),
            'usersWhichEmptyByCondition' => array(
                self::HAS_MANY,
                'User',
                array('user_id' => 'id'),
                'through' => 'rolesWhichEmptyByCondition'
            ),
        );
    }
...
class Post extends CActiveRecord
{
    ...
    public function scopes()
    {
        ...
        return array(
            ...
            'post23A'   => array(
                'condition' => "$this->tableAlias.id=2 OR $this->tableAlias.id=3",
    ...
    public function relations()
    {
        ...
        return array(
            'comments' => array(
                ...
                'with'  => array('post' => array('alias' => 'post'), 'author')
            ),
        );
    }
}
...
class UserWithWrappers extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'postsWithScope' => array(
                self::HAS_MANY,
                'PostWithWrappers',
                'author_id',
                'scopes' => array('replaceContent')
            ),
