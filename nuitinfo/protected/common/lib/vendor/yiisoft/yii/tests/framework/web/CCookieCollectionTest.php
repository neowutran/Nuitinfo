...
class CCookieCollectionTest extends CTestCase
{
    ...
    public function testRemove()
    {
        ...
        $this->assertTrue(
            $this->cookies->contains('testCookieOne'),
            'A default cookie is missing! Check the testcase!'
        );
        $this->assertTrue(
            $this->cookies->contains('someEmptyCookie'),
            'A default cookie is missing! Check the testcase!'
        );
        $this->assertTrue(
            $this->cookies->contains('someEmptyCookie'),
        ...
        $this->assertTrue(
            $this->cookies->contains('cookieWithOptions'),
            'A default cookie is missing! Check the testcase!'
        );
        // Real tests below:
        foreach ($this->testCookies as $name => $options) {
    ...
    public function testGetRequest()
    {
        ...
        $this->assertEquals(
            $this->request,
            $this->cookies->getRequest(),
            'The collections does not contain the CHttpRequest instance it is stored in.'
        );
    }
}