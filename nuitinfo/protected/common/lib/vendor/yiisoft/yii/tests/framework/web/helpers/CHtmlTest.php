...
class CHtmlTest extends CTestCase
{
    ...
    public static function providerEncodeArray()
    {
        ...
        return array(
            ...
            array(
                array(array('lessThanExpression' => '4 < 9'), 'greaterThanExpression' => '4 > 9'),
                array(array('lessThanExpression' => '4 &lt; 9'), 'greaterThanExpression' => '4 &gt; 9')
            )
        );
    }
    ...
    public static function providerAjax()
    {
        ...
        return array(
            ...
            array(
                array("url" => "index", "success" => "function() { this.alert(\"HI\"); }"),
                "jQuery.ajax({'url':'index','success':function() { this.alert(\"HI\"); },'cache':false});"
            ),
            array(
                array("async" => true, "success" => "function() { this.alert(\"HI\"); }"),
                "jQuery.ajax({'async':true,'success':function() { this.alert(\"HI\"); },'url':location.href,'cache':false});"
            ),
            array(
                array("update" => "#my-div", "success" => "function() { this.alert(\"HI\"); }"),
                "jQuery.ajax({'success':function() { this.alert(\"HI\"); },'url':location.href,'cache':false});"
            ),
            array(
                array("update" => "#my-div"),
                "jQuery.ajax({'url':location.href,'cache':false,'success':function(html){jQuery(\"#my-div\").html(html)}});"
            ),
            array(
                array("replace" => "#my-div", "success" => "function() { this.alert(\"HI\"); }"),
                "jQuery.ajax({'success':function() { this.alert(\"HI\"); },'url':location.href,'cache':false});"
            ),
            array(
                array("replace" => "#my-div"),
                "jQuery.ajax({'url':location.href,'cache':false,'success':function(html){jQuery(\"#my-div\").replaceWith(html)}});"
            )
        );
    }
    ...
    public static function providerActiveDOMElements()
    {
        ...
        return array(
            array(
                new CHtmlTestModel(array('attr1' => true)),
                'attr1',
                array(),
                '<input id="ytCHtmlTestModel_attr1" type="hidden" value="0" name="CHtmlTestModel[attr1]" /><input name="CHtmlTestModel[attr1]" id="CHtmlTestModel_attr1" value="1" type="checkbox" />'
            ),
            array(
                new CHtmlTestModel(array('attr1' => false)),
                'attr1',
                array(),
                '<input id="ytCHtmlTestModel_attr1" type="hidden" value="0" name="CHtmlTestModel[attr1]" /><input name="CHtmlTestModel[attr1]" id="CHtmlTestModel_attr1" value="1" type="checkbox" />'
            )
    ...
    public static function providerBeginForm()
    {
        ...
        return array(
            ...
            array(
                "index?myFirstParam=3&mySecondParam=true",
                "get",
                array(),
    ...
    public static function providerTextArea()
    {
        ...
        return array(
            ...
            array(
                "textareaone",
                '',
                array("id" => "MyAwesomeTextArea", "dog" => "Lassie", "class" => "colorful bright"),
                "<textarea id=\"MyAwesomeTextArea\" dog=\"Lassie\" class=\"colorful bright\" name=\"textareaone\"></textarea>"
            ),
    ...
    public function providerOpenTag()
    {
        ...
        return array(
            ...
            array(
                'option',
                array('checked' => true, 'disabled' => false, 'defer' => true),
                '<option checked="checked" defer="defer">'
            ),
            array(
                'another-tag',
                array('some-attr' => '<>/\\<&', 'encode' => true),
                '<another-tag some-attr="&lt;&gt;/\&lt;&amp;">'
            ),
    ...
    public function providerMetaTag()
    {
        ...
        return array(
            ...
            array(
                ...
                null,
                null,
                array('xhtml-invalid-attr' => 'attr-value'),
    ...
    public static function providerCssFile()
    {
        ...
        return array(
            array(
                '/css/style.css?a=1&b=2',
                '',
                '<link rel="stylesheet" type="text/css" href="/css/style.css?a=1&amp;b=2" />'
            ),
            array(
                '/css/style.css?c=3&d=4',
                'screen',
                '<link rel="stylesheet" type="text/css" href="/css/style.css?c=3&amp;d=4" media="screen" />'
            ),
        );
    }
    ...
    public function providerValue()
    {
        ...
        $result = array(
            ...
            array(
                (object)array('k1' => 'v1', 'k2' => 'v2', 'v3', 'v4'),
                array('CHtmlTest', 'helperTestValue'),
                null,
                'v2'
            ),
            // create_function is not supported by CHtml::value(), we're just testing this feature/property
            array(
                array('k1' => 'v1', 'k2' => 'v2', 'v3', 'v4'),
                create_function('$model', 'return $model["k2"];'),
                null,
                null
            ),
            array(
            ...
            array(
                array('array_filter' => 'array_filter', 'sort' => 'sort'),
                'array_map',
                'defaultValue',
                'defaultValue'
            ),
            ...
            array(
                (object)array('array_filter' => 'array_filter', 'sort' => 'sort'),
                'array_map',
                'defaultValue',
                'defaultValue'
            ),
            ...
            // dot access, object
            array(
                (object)array('k1' => array('k2' => array('k3' => 'v3')), array('v1', 'k4' => 'v4')),
                'k1.k2.k3',
                null,
                'v3'
            ),
    ...
    public static function providerPageStateField()
    {
        ...
        return array(
            array(
                'testing-value',
                '<input type="hidden" name="' . CController::STATE_INPUT_NAME . '" value="testing-value" />'
            ),
            array(
                'another-testing&value',
                '<input type="hidden" name="' . CController::STATE_INPUT_NAME . '" value="another-testing&value" />'
            ),
        );
    }
    ...
    public static function providerImage()
    {
        ...
        return array(
            ...
            array(
                '/img/test.jpg',
                '',
                array('class' => 'test-img'),
                '<img class="test-img" src="/img/test.jpg" alt="" />'
            ),
        );
    }
    ...
    public function providerActiveLabel()
    {
        ...
        return array(
            ...
            array(
                false,
                'userName',
                array('for' => 'someTestingInput'),
                '<label for="someTestingInput">User Name</label>'
            ),
            array(
                false,
                'userName',
                array('label' => 'Custom Label'),
                '<label for="CHtmlTestActiveModel_userName">Custom Label</label>'
            ),
            ...
            array(
                ...
                'userName',
                array(),
                '<label class="error" for="CHtmlTestActiveModel_userName">User Name</label>'
            ),
            array(
                true,
                'userName',
                array('for' => 'someTestingInput'),
                '<label class="error" for="someTestingInput">User Name</label>'
            ),
            array(
                true,
                'firstName',
                array('label' => 'Custom Label'),
                '<label for="CHtmlTestActiveModel_firstName">Custom Label</label>'
            ),
    ...
    public function providerActiveLabelEx()
    {
        ...
        return array(
            ...
            array(
                ...
                'firstName',
                array('for' => 'someTestingInput'),
                '<label for="someTestingInput">First Name</label>'
            ),
            array(
                false,
                'userName',
                array('label' => 'Custom Label'),
                '<label for="CHtmlTestActiveModel_userName" class="required">Custom Label <span class="required">*</span></label>'
            ),
            array(false, 'userName', array('label' => false), ''),
            array(
                true,
                'userName',
                array(),
                '<label class="error required" for="CHtmlTestActiveModel_userName">User Name <span class="required">*</span></label>'
            ),
            array(
                true,
                'userName',
                array('for' => 'someTestingInput'),
                '<label class="error required" for="someTestingInput">User Name <span class="required">*</span></label>'
            ),
            array(
                true,
                'firstName',
    ...
    public function providerActiveUrlField()
    {
        ...
        return array(
            ...
            array(
                true,
                'firstName',
                array('disabled' => true, 'name' => 'changed-name'),
    ...
    public function providerButton()
    {
        ...
        return array(
            array(
                'button1',
                array('name' => null, 'class' => 'class1'),
                '<input class="class1" type="button" value="button1" />'
            ),
            array(
                'button2',
                array('name' => 'custom-name', 'class' => 'class2'),
                '<input name="custom-name" class="class2" type="button" value="button2" />'
            ),
            array('button3', array('type' => 'submit'), '<input type="submit" name="yt0" value="button3" />'),
            array(
                'button4',
                array('value' => 'button-value'),
                '<input value="button-value" name="yt0" type="button" />'
            ),
    ...
    public function providerHtmlButton()
    {
        ...
        return array(
            array(
                'button1',
                array('name' => null, 'class' => 'class1'),
                '<button name="yt0" class="class1" type="button">button1</button>'
            ),
            array(
                'button2',
                array('name' => 'custom-name', 'class' => 'class2'),
                '<button name="custom-name" class="class2" type="button">button2</button>'
            ),
            array('button3', array('type' => 'submit'), '<button type="submit" name="yt0">button3</button>'),
            array(
                'button4',
                array('value' => 'button-value'),
                '<button value="button-value" name="yt0" type="button">button4</button>'
            ),
    ...
    public function providerImageButton()
    {
        ...
        return array(
            array(
                ...
                array('src' => 'ignored-src'),
                '<input src="/images/test-image.png" type="image" name="yt0" />'
            ),
            array(
                '/images/test-image.jpg',
                array('type' => 'button'),
                '<input type="image" src="/images/test-image.jpg" name="yt0" />'
            ),
            array(
                '/images/test-image.gif',
                array('value' => 'image'),
                '<input value="image" src="/images/test-image.gif" type="image" name="yt0" />'
            ),
        );
    }
    ...
    public function providerLinkButton()
    {
        ...
        return array(
            array(
                'submit',
                array(),
                '<a href="#" id="yt0">submit</a>',
                "jQuery('body').on('click','#yt0',function(){jQuery.yii.submitForm(this,'',{});return false;});"
            ),
            array(
                'link-button',
                array(),
                '<a href="#" id="yt0">link-button</a>',
                "jQuery('body').on('click','#yt0',function(){jQuery.yii.submitForm(this,'',{});return false;});"
            ),
            array(
                'link-button',
                array('href' => 'http://yiiframework.com/'),
                '<a href="#" id="yt0">link-button</a>',
    ...
    public function testAjaxCallbacks()
    {
        ...
        $this->assertTrue(
            mb_strpos($out, "'success':function() { /* callback */ }", null, Yii::app()->charset) !== false,
            "Unexpected JavaScript: " . $out
        );
