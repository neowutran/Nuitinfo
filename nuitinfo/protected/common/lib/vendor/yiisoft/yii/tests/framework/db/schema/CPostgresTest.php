...
class CPostgresTest extends CTestCase
{
    ...
    public function testCommandBuilder()
    {
        ...
        $this->assertEquals(
            'INSERT INTO "test"."posts" ("title", "create_time", "author_id", "content") VALUES (:yp0, :yp1, :yp2, :yp3)',
            $c->text
        );
        $c->execute();
        ...
        $this->assertEquals(
            '"test"."posts"."id"=:yp0 AND "test"."posts"."author_id"=:yp1 AND (title=\'\')',
            $c->condition
        );
    }
    ...
    public function testResetSequence()
    {
        ...
        $this->db->createCommand(
            "INSERT INTO test.users (username, password, email) VALUES ('user4','pass4','email4')"
        )->execute();
