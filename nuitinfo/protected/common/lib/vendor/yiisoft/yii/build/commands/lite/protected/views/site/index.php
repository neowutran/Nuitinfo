...
<p>
    This is the homepage of <em><?php echo Yii::app()->name; ?></em>. You may modify the following files to customize
    the conent of this page:
</p>
<dl>
    ...
    <dd>This is the layout file that contains common presentation (such as header, footer) shared by all view files.
    </dd>
</dl>

<h3>What's Next</h3>
<ul>
    <li>Implement new actions in <tt>SiteController</tt>, and create corresponding views under <?php echo Yii::app(
            )->viewPath . DIRECTORY_SEPARATOR . 'site'; ?></li>
    ...
    <li>If your Web application should be driven by database, do the following:
        <ul>
            <li>Set up database connection by configuring the <code>db</code> component in the application configuration
                <tt><?php echo Yii::app(
                        )->basePath . DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR . 'main.php'; ?></tt></li>
            ...
            <li>Implement CRUD operations for a model class. For example, for the <tt>Post</tt> model class,
                ...
                <tt>update</tt> and <tt>delete</tt> actions.
            </li>
        </ul>
